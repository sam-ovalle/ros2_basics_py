...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'text_recog_s_server_custom_executable = mars_rover_tasks.text_recog_s_server_custom:main',
            'text_recog_s_client_custom_executable = mars_rover_tasks.text_recog_s_client_custom:main',
        ],
    },
)
